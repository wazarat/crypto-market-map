-- Add Fiat-Referenced Token Companies (Minimal Version)
-- Uses NULL for license_status to avoid constraint issues
...
-- Insert the new fiat token companies with NULL license_status to avoid constraints
...
('paxos', 'Paxos Trust Company', 2012, 'Charles Cascarilla', 'New York, USA', 'https://paxos.com',
 ...
 (SELECT id FROM vasp_categories WHERE slug = 'fiat-tokens'), false, 'info@paxos.com', 'Verified'),
...
('terraform-labs', 'Terraform Labs', 2018, 'Do Kwon', 'Singapore', 'https://terra.money',
 ...
 (SELECT id FROM vasp_categories WHERE slug = 'fiat-tokens'), false, 'contact@terra.money', 'Defunct'),
...
('first-digital-labs', 'First Digital Labs', 2021, 'Vincent Chok', 'Hong Kong', 'https://firstdigitallabs.com',
 ...
 (SELECT id FROM vasp_categories WHERE slug = 'fiat-tokens'), false, 'info@firstdigitallabs.com', 'Verified'),
...
('archblock', 'Archblock (formerly TrustToken)', 2018, 'Rafael Cosman', 'San Francisco, USA', 'https://trueusd.com',
 ...
 (SELECT id FROM vasp_categories WHERE slug = 'fiat-tokens'), false, 'support@trueusd.com', 'Verified');
