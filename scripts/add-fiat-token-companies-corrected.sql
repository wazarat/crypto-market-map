-- Add Fiat-Referenced Token Companies (Corrected License Status)
-- Uses standard license status values that should be allowed
...
-- Insert the new fiat token companies with corrected license_status values
...
('paxos', 'Paxos Trust Company', 2012, 'Charles Cascarilla', 'New York, USA', 'https://paxos.com',
 ...
 (SELECT id FROM vasp_categories WHERE slug = 'fiat-tokens'), false, 'info@paxos.com', NULL, 'Licensed', 'Verified'),
...
('terraform-labs', 'Terraform Labs', 2018, 'Do Kwon', 'Singapore', 'https://terra.money',
 ...
 (SELECT id FROM vasp_categories WHERE slug = 'fiat-tokens'), false, 'contact@terra.money', NULL, 'None', 'Defunct'),
...
('first-digital-labs', 'First Digital Labs', 2021, 'Vincent Chok', 'Hong Kong', 'https://firstdigitallabs.com',
 ...
 (SELECT id FROM vasp_categories WHERE slug = 'fiat-tokens'), false, 'info@firstdigitallabs.com', NULL, 'Licensed', 'Verified'),
